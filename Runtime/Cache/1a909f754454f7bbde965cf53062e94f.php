...
<form class="form-signin" id="selectTreaty" name="selectTreaty" method="post" action="<?php echo U('User/toSubBySelect');?>" >
	<div class="row demo-row">
		<h2><center>减分订单</center></h2>
...
<form class="form-signin" id="newPost" name="newPost" method="post" action="<?php echo U('User/toSub');?>" >
	<div class="row demo-row">
		<h3 class="demo-panel-title">或者输入理由及扣除爱情币的数目</h3>
		<div class="col-md-7">
			1.理由：
