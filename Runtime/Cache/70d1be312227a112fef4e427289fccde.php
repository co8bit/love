	...
	<div class="login2">
		<div class="login-screen">
			<div class="login-icon">
				...
				<h4><?php echo (session('_APPNAME')); ?><small>关联申请</small></h4>
			</div>
			
			<form class="form-signin" id="login" name="login" method="post" action="<?php echo U('User/verifyTempCon');?>" >
				<div class="login-form">
					<b><font color="#000000"><center>关联申请处理</center></font></b>
					<font color="#000000"><p>对方账户名：</font>
					<div class="form-group">
						<input class="form-control login-field" value=<?php echo ($pairUserName); ?> disabled="disabled" id="pairUserName" name="pairUserName" type="text">
					...
					<button class="btn btn-primary btn-lg btn-block" type="submit">同意与对方关联</button>
					<a class="btn btn-primary btn-lg btn-block" href="<?php echo U('User/ignoreTempPair');?>">忽视此申请</a>
